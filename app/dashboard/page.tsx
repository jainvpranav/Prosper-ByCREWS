            ...
            <div className="flex items-center justify-between flex-col sm:flex-row gap-4 mb-6">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
                  <span className="text-sm font-medium text-primary">Patient ID: PROS-2025-0421</span>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              },
              {
                ...
                desc: 'Reduce processed foods and increase vegetables',
              },
              {
                num: '3',
                title: 'Schedule Checkup',
                desc: 'Book an appointment with your healthcare provider',
              },
            ].map((action, idx) => (
